...
@bot.tree.command(name="deploy-alpine", description="Tạo một Instance mới với Alpine 3.14")
async def deploy_ubuntu(interaction: discord.Interaction):
...
async def help_command(interaction: discord.Interaction):
    ...
    embed.add_field(name="/deploy-alpine", value="Tạo một Instance mới với Alpine 3.14.", inline=False)
