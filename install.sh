...
echo "Writing Dockerfile-Alphine.../Viết Dockerfile-Alphine..."
wget https://github.com/Snhvn/discord-vps-creator-vn-by-Snipavn-katy/raw/refs/heads/main/install-dockerfile-alphine.sh && chmod +x install-dockerfile-alphine.sh && ./install-dockerfile-alphine.sh
...
sudo docker build -t ubuntu-22.04-with-tmate . && sudo docker build -t debian-with-tmate -f Dockerfile2 .
