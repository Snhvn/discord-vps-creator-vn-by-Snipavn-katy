...
wget https://github.com/Snhvn/discord-vps-creator-vn-by-Snipavn-katy/raw/refs/heads/main/install-dockerfile.sh && chmod +x install-dockerfile.sh && sudo ./install-dockerfile.sh && rm install-dockerfile.sh
...
echo -e "Enter "1-en" (English) (Ubuntu-22.04) or Enter "2-en" (English) (Full commands and add debian 12)/Nhập "1-vi" (Tiếng Việt) (Ubuntu-22.04) hoặc Nhập "2-vi" (Tiếng Việt) (Đầy đủ các lệnh và thêm debian-12), Nhập "3-vi" (Tiếng Việt) (Đầy đủ các lệnh và thêm Alpine và Fedora,Openwrt) "
read pythonnumber
