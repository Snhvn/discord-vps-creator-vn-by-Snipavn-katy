...
@bot.tree.command(name="deploy-alpine", description="Creates a new Instance with Alpine 3.19")
async def deploy_ubuntu(interaction: discord.Interaction):
...
async def list_servers(interaction: discord.Interaction):
    ...
    if servers:
        ...
        for server in servers:
            ...
            embed.add_field(name=container_name, value="Description: A server with (your ram) GB RAM and (Your Cores) cores.", inline=False)
        await interaction.response.send_message(embed=embed)
    else:
...
async def help_command(interaction: discord.Interaction):
    ...
    embed.add_field(name="/deploy-alpine", value="Create a new Instance with Alpine 3.19", inline=False) 
    embed.add_field(name="/deploy-fedora", value="Create a new Instance with Fedora", inline=False)
