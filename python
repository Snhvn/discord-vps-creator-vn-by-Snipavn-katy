...
@bot.tree.command(name="deploy", description="Tạo một Instance mới với Ubuntu 24.04")
...
async def help_command(interaction: discord.Interaction):
    ...
    embed.add_field(name="/deploy", value="Tạo một Instance mới với Ubuntu 24.04.", inline=False)
